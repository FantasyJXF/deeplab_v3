...
# 
# Last Modified: Thursday September 26th 2019 5:57:09 pm
# 
...
tf.app.flags.DEFINE_string('checkpoint_dir', 'tboard_logs/16645/train',
                           """Directory where to read training checkpoints.""")
tf.app.flags.DEFINE_string('output_dir', 'tboard_logs/16645/test',
                           """Directory where to export inference model.""")
tf.app.flags.DEFINE_integer('model_version', 1,
                            """Version number of the model.""")
tf.app.flags.DEFINE_integer('image_size', 513,
